...
<div class="tabs-wrapper">
    <ul class="tabs">
        <li class="tab"><a href="./youmaylike.php">YOU MIGHT LIKE</a></li>
        <li class="tab"><a class="active" href="./member.php">MEMBER</a></li>
        <li class="tab"><a class="" href="./yours.php">YOURS</a></li>
    </ul>
</div>
