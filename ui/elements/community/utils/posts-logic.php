<!-- ui/elements/community/utils/posts-logic.php -->
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SESSION['username'])) {
    if (isset($_POST['postContent']) && !empty($_POST['postContent'])) {
       ...
       include("db-com.php");
        ...
        $query = "INSERT INTO `$communityName` (username, content, image_url, image_link, post_link, created_at) VALUES (?, ?, ?, ?, ?, NOW())";
...
if (isset($_SESSION['username'])) {
    ...
    $query = "SELECT * FROM $communityName ORDER BY created_at DESC";
